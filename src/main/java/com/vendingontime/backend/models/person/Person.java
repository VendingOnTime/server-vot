...
@NamedQueries({
        ...
        @NamedQuery(name = "Person.findTechniciansByCompany",
                query = "SELECT p FROM Person p WHERE p.company.id = :companyId " +
                        "AND p.role = com.vendingontime.backend.models.person.PersonRole.TECHNICIAN " +
